import workzenslide1 from "@/assets/images/ServicesSolutionsImgs/workzenslide1.svg";
import workzenslide3 from "@/assets/images/ServicesSolutionsImgs/workzenslide2.svg";
import workzenslide2 from "@/assets/images/ServicesSolutionsImgs/workzenslide3.svg";
import yaranty1 from "@/assets/images/ServicesSolutionsImgs/yaranty1.svg";
import yaranty3 from "@/assets/images/ServicesSolutionsImgs/yaranty2.svg";
import yaranty2 from "@/assets/images/ServicesSolutionsImgs/yaranty3.svg";
import hib1 from "@/assets/images/ServicesSolutionsImgs/hib1.svg";
import hib3 from "@/assets/images/ServicesSolutionsImgs/hib2.svg";
import hib2 from "@/assets/images/ServicesSolutionsImgs/hib3.svg";
import pm1 from "@/assets/images/ServicesSolutionsImgs/pm1.svg";
import pm2 from "@/assets/images/ServicesSolutionsImgs/pm2.svg";
import pm3 from "@/assets/images/ServicesSolutionsImgs/pm3.svg";
import crm1 from "@/assets/images/ServicesSolutionsImgs/crm1.svg";
import crm3 from "@/assets/images/ServicesSolutionsImgs/crm2.svg";
import crm2 from "@/assets/images/ServicesSolutionsImgs/crm3.svg";
// Additional solution images (assuming these are already available)
// import belloSlide1 from "@/assets/images/ServicesSolutionsImgs/belloSlide1.svg";
// import belloSlide2 from "@/assets/images/ServicesSolutionsImgs/belloSlide2.svg";
// import belloSlide3 from "@/assets/images/ServicesSolutionsImgs/belloSlide3.svg";
// import yarrantySlide1 from "@/assets/images/ServicesSolutionsImgs/yarrantySlide1.svg";
// import yarrantySlide2 from "@/assets/images/ServicesSolutionsImgs/yarrantySlide2.svg";
// import yarrantySlide3 from "@/assets/images/ServicesSolutionsImgs/yarrantySlide3.svg";
// import visitlySlide1 from "@/assets/images/ServicesSolutionsImgs/visitlySlide1.svg";
// import visitlySlide2 from "@/assets/images/ServicesSolutionsImgs/visitlySlide2.svg";
// import visitlySlide3 from "@/assets/images/ServicesSolutionsImgs/visitlySlide3.svg";
// import echocrmSlide1 from "@/assets/images/ServicesSolutionsImgs/echocrmSlide1.svg";
// import echocrmSlide2 from "@/assets/images/ServicesSolutionsImgs/echocrmSlide2.svg";
// import echocrmSlide3 from "@/assets/images/ServicesSolutionsImgs/echocrmSlide3.svg";
// import flowerpSlide1 from "@/assets/images/ServicesSolutionsImgs/flowerpSlide1.svg";
// import flowerpSlide2 from "@/assets/images/ServicesSolutionsImgs/flowerpSlide2.svg";
// import flowerpSlide3 from "@/assets/images/ServicesSolutionsImgs/flowerpSlide3.svg";

export const dataofsolutions = {
  workzenPro: {
    hero: {
    ...
    middle: {
      title:
        "One Platform to Manage Shifts, Attendance, and Time – Effortlessly",
      description:
    ...
    features: {
      title: "Key Features of Workzen",
      image: workzenslide3,
      blocks: [
        {
          title: "Shift Planning Made Simple",
          description:
            "Create, tweak, and assign shifts easily based on your team's availability, in a simple way.",
        },
        {
          title: "Accurate Attendance Tracking",
          description:
            "No more guesswork. Our system tracks every check-in, check-out, and completed shift automatically.",
        },
        {
          title: "Real-Time Updates",
          description:
            "Instant alerts when shifts change, swap, or wrap up. No more chasing people for updates!",
        },
        {
  ...
  bello: {
    ...
    middle: {
      ...
      why: [
        ...
        "Goal setting to track your progress effectively",
        "Real-time updates to keep you motivated",
        "Holistic care for both mind and body",
      ],
    },
    features: {
      title: "Key Features of Bello",
      image: workzenslide1,
      blocks: [
        {
          title: "Meal Tracking",
          description:
            "Track your meals and calories to maintain a balanced diet.",
        },
        {
          title: "Workout Planner",
          description:
            "Create custom workout routines and track your progress.",
        },
        {
          title: "Sleep Tracker",
          description:
            "Monitor your sleep patterns to ensure you’re getting quality rest.",
        },
      ],
    },
  },
  ...
  echocrm: {
    ...
    features: {
      title: "Key Features of EchoCRM",
      image: crm3,
      blocks: [
        {
          title: "Sales Pipeline Management",
          description:
            "Easily track your leads and sales, from initial contact to closing the deal.",
        },
        {
          title: "Customer Interaction Tracking",
          description:
            "Keep detailed notes on all customer interactions for better relationship management.",
        },
        {
          title: "Performance Analytics",
          description:
            "Gain insights into your sales team's performance and optimize your strategy.",
        },
      ],
    },
  },
  ...
  flowpm: {
    hero: {
      title: "Flowerp – Grow Your Business with Flowers",
      description:
        "Flowerp is your go-to platform for managing floral arrangements, delivery scheduling, and customer management. Whether you're running a florist shop or a flower delivery service, Flowerp helps streamline your business.",
      image: pm1,
    },
    middle: {
      title: "Floral Management Made Simple",
      description:
        "From flower inventory to delivery management, Flowerp simplifies every aspect of your floral business.",
      image: pm2,
      why: [
        "Makes visitor and staff management simple",
        "Real-time updates for better oversight",
    ...
    features: {
      title: "Key Features of Flowerp",
      image: pm3,
      blocks: [
        {
          title: "Inventory Management",
          description:
            "Track your floral inventory in real time to ensure you never run out of popular arrangements.",
        },
        {
          title: "Order and Delivery Tracking",
          description:
            "Manage customer orders and track delivery status effortlessly.",
        },
        {
          title: "Customer Management",
          description:
            "Keep a record of your customers' preferences and order history for personalized service.",
        },
      ],
    },
  },
